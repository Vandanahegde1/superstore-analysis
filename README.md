...
1. **Sales grew 47% from 2014 to 2017** — Consistent year-over-year growth shows strong business expansion.

2. **Technology is the most profitable category** — Leads profit at $0.15M while Furniture barely breaks even at $0.02M.

3. **West region leads in profit** — West tops at $108K, Central is the weakest at $40K.

4. **Consumer segment dominates sales** — Accounts for $1.16M, nearly double Corporate ($0.71M).

5. **Standard Class is the preferred shipping mode** — Nearly 60% of orders use it, showing customers prefer cost over speed.

---

## Business Recommendations

1. **Reduce discounts on Furniture** — Heavy discounting is hurting margins. Focus on higher-margin products.

2. **Invest more in West + Technology** — This is the most profitable combination. Increase marketing and inventory focus here.
